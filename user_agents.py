"""
用户代理池
提供多种常见浏览器的User-Agent，随机使用不同的User-Agent可以降低被封锁的风险
"""

import random

# 各种主流浏览器的常见 User-Agent
USER_AGENTS = [
    # Chrome - Windows
    ...
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/121.0.6167.87 Mobile/15E148 Safari/604.1",
]
